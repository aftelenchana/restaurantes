...
function sendemail($imagen,$mail_setFromName,$mail_addAddress,$txt_message,$mail_subject, $template,$mostrar_mensaje){
	...
	$mail->Username = "tucorreo@gmail.com";     // Correo electronico saliente ejemplo: tucorreo@gmail.com
	$mail->Password = "tucontraseña"; 			// Tu contraseña de gmail
	$mail_setFromEmail = "tucorreo@gmail.com";  // Correo electronico nuevamente
