<?php
  ...
  $_SESSION["zona_horaria"] = 'America/Lima';
?>
...
<head>
    ...
    <link href="assets/fonts/icofont/icofont.css" rel="stylesheet">
    <link href="assets/fonts/font/flaticon.css" rel="stylesheet">
    <link href="assets/jquery-ui-1.12.1/jquery-ui.min.css" rel="stylesheet" />
    <link href="assets/css/plugins/chosen/bootstrap-chosen.css" rel="stylesheet">
    <link href="assets/css/plugins/toastr/toastr.min.css" rel="stylesheet">
    <link href="assets/css/animate.css" rel="stylesheet">
    <link href="assets/css/style.min.css" rel="stylesheet">
    <link href="assets/css/stylep.min.css" rel="stylesheet">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li id="restau">
                        <a href="inicio.php"><i class="fa fa-desktop"></i> <span class="nav-label">Punto de Venta</span></a>
                    </li>
                    <?php } if($reg['id_rol'] == 1 or $reg['id_rol'] == 2) { ?>
                    <li id="caja">
                        <a href="#"><i class="fa fa-money"></i> <span class="nav-label">Caja</span><span class="fa arrow"></span></a>
            ...
            <div class="row border-bottom">
                <nav id="navbar-c" class="navbar navbar-fixed-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="listar-pedidos-preparados">
                            <a class="count-info" data-toggle="modal" data-target="#mdl-pedidos-preparados">
                                <i class="fa fa-bell" style="font-size:18px"></i><span class="label label-warning contador-pedido"></span>
                            </a>
                        </li>
                        <li>
