...
<div class="wrapper wrapper-content animated fadeIn">
	<div class="ibox">
		<div class="ibox-title">
			...
			<h5><i class="fa fa-list"></i> Lista de Compras al Cr&eacute;dito</h5>
		</div>
		<div class="ibox-content" style="position: relative; min-height: 30px;">
			...
			<div class="punteo">
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <h5 class="no-margins"><strong>Pendiente</strong></h5>
...
<div class="modal inmodal fade" id="mdl-credito" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="true">
    <div class="modal-dialog modal-sm">
        <div class="modal-content animated bounceInRight">
        <form id="frm-credito" method="post" enctype="multipart/form-data" action="?c=Credito&a=pagarCuota">
...
<script src="assets/scripts/creditos/compras/func-compras.js"></script>
