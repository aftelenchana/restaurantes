<?php
	...
	$tituloReporte = "Reporte Kardex de Insumos";
	$titulosColumnas = array('Fecha','Comprobante','Serie','Numero','Concepto','Cantidad','Costo Uni.','Total','Cantidad','Costo Uni.','Total','Cantidad','Costo Uni.','Total');
	
	$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A1:O2');
		...
		*/
		...
		$objPHPExcel->getActiveSheet()->getStyle('A1:O2')->applyFromArray($estiloTituloReporte);
