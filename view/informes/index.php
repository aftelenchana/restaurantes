    ...
    <div class="ibox-content m-b-sm border-bottom">
        <div class="p-xs">
            <div class="pull-left m-r-md">
                <i class="fa fa-list-ul mid-icon"></i>
            </div>
            <h2 class="m-t-none">Informes</h2> <span>Mira y analiza todos los números que genera tu negocio.</span>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6">
...
<script src="assets/scripts/informes/func_inf.js"></script>
