	...
	.DataTable({
        ...
                return '<p class="text-right bold"> '+moneda+' '+formatNumber(data)+'</p>';
            ...
                    return '<p class="text-center">'
                    +'<a class="btn btn-xs btn-success" onclick="detalle('+data.id_compra+')"><i class="fa fa-files-o"></i></a>'
                    +'&nbsp<a class="btn btn-xs btn-info" onclick="detalle_c('+data.id_compra+')"><i class="fa fa-eye"></i> Ver</a>'
                    +'</p>';
                }
            }
		]
