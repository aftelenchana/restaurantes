...
var listarTiposDoc = function(){
    ...
    .DataTable({
        ...
        "columns":[
            ...
            {"data":"numero"},
            {"data":null,"render": function ( data, type, row) {
                return '<div class="text-right"><a class="btn btn-success btn-xs" onclick="editarTipoDoc('+data.id_tipo_doc+',\''+data.descripcion+'\',\''+data.serie+'\',\''+data.numero+'\');"><i class="fa fa-edit"></i> Editar</a></div>';
            }}
        ]
    });
}
