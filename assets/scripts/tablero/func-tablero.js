...
$.ajax({
    ...
    success: function(item){
        ...
        $('.efe').text(moneda+" "+formatNumber(item['data1'].efe));
        $('.tar').text(moneda+" "+formatNumber(item['data1'].tar));
        $('.des').text(moneda+" "+formatNumber(item['data1'].des));
        $('#ing').text(moneda+" "+formatNumber(item['data13'].ting));
        $('#gas').text(moneda+" "+formatNumber(item['data2'].tgas));
        $('.total_v').text(moneda+" "+formatNumber(totalVentas));
        $('#efe_real').text(moneda+" "+formatNumber(efectivoReal));
        $('.efe_p').text(formatNumber(efectivo)+"%");
        $('.tar_p').text(formatNumber(tarjeta)+"%");
